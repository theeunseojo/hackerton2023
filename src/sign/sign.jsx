      ...
      <div className="page">
        ...
        <form className="contentWrap">
          <div className="inputbox">
            <div className="inputTitle inputbox">닉네임</div>
            <div
              className="inputWrap">
              <input 
            ...
            <div className="errorMessageWrap">
              {!idValid && id.length > 0 && (
                <div className="inputbox">3자 이상의 닉네임을 입력해주세요.</div>
              )}
            </div>

            <div  className="inputTitle  inputbox">
              아이디
            </div>
            ...
            <div className="errorMessageWrap">
              {!idValid && id.length > 0 && (
                <div className="inputbox">영문, 숫자 포함 5자 이상 입력해주세요.</div>
              )}
            </div>
            ...
            <div className="errorMessageWrap  inputbox">
              {!pw2Valid && handlePw !== handlePw2 && (
                <div className="inputbox">비밀번호가 일치하지 않습니다.</div>
              )}
            </div>
          </div>
